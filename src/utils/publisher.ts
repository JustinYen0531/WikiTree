...
<head>
  ...
  <style>
    ...
    * {
    ...
    .note-frontmatter-icon--domain { border: 1px solid currentColor; border-radius: 50%; background: linear-gradient(currentColor, currentColor) center / 100% 1px no-repeat, linear-gradient(90deg, transparent 44%, currentColor 45% 55%, transparent 56%) center / 7px 100% no-repeat; }
    .note-frontmatter-icon--domain::after { content: ""; position: absolute; inset: 3px -1px; border-top: 1px solid currentColor; border-bottom: 1px solid currentColor; border-radius: 50%; }
    .note-frontmatter-icon--branch { background: radial-gradient(circle at 4px 3px, currentColor 0 1.5px, transparent 1.7px), radial-gradient(circle at 12px 8px, currentColor 0 1.5px, transparent 1.7px), radial-gradient(circle at 4px 13px, currentColor 0 1.5px, transparent 1.7px), linear-gradient(currentColor, currentColor) 4px 3px / 1px 10px no-repeat, linear-gradient(currentColor, currentColor) 4px 8px / 8px 1px no-repeat; }
    .note-frontmatter-icon--parent::before { content: ""; position: absolute; left: 7px; top: 3px; width: 7px; height: 7px; border-top: 1px solid currentColor; border-left: 1px solid currentColor; transform: rotate(45deg); }
    .note-frontmatter-icon--parent::after { content: ""; position: absolute; left: 7px; top: 3px; width: 1px; height: 11px; background: currentColor; }
